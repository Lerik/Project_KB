...
<form enctype="multipart/form-data" class="formoid-default" style="background-color:#FFFFFF;font-size:16px;font-family:Tahoma,Geneva,sans-serif;width:480px" title="Kanban Board Project" method="post" runat=server>
	...
	<div class="element-email" ><label class="title" id="email_label">Correo Electrónico<span class="required">*</span></label><input type="text" name="email" value="" id="email" required="required" runat=server/></div>
	<div class="element-input" ><label class="title">Nombre de Usuario<span class="required">*</span></label><input type="text" name="input1" id="user" required="required" runat=server/></div>
    ...
    <div class="element-email" ><label class="title">Código en la imagen<span class="required">*</span></label><input type="text" name="code" value="" id="code" required="required" runat=server/></div>
