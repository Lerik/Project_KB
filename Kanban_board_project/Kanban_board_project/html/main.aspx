...
<form class="formoid-default" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;width:480px" title="My Formoid form" method="post" runat=server>
	<div class="element-text" ><h2 class="title">Iniciar Sesión</h2></div>
	<div class="element-input" ><label class="title" id="lbluser">Usuario</label><input type="text" name="input" id="user" required="required" runat="server" /></div>
	<div class="element-password" ><label class="title">Contraseña</label><input type="password" name="password" value="" id="pass" required="required" runat="server"/></div>
